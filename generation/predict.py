...
pretrain_checkpoint_path = './pretrain_weights/mt5_base/model.ckpt-1000000'
...
weights_paths = glob.glob('./param/outputModelWeights/ICLR_2021_Workshop_MLPCP_Track_1_生成*/best_weights')
